...
if __name__ == "__main__":
    ...
    write_file = open(data_dir + 'simulated_corpus.txt', 'w')   
    leaf_label = open(data_dir + 'leaf_label.txt', 'w') 
    for b in range(num_brands):
        for i in range(D):
            ...
            for j in range(sentence_num):
                ...
                for n in range(words_num):
                    ...
                    w = np.random.choice(select_topic.words)
                    sentence += str(w)
                    sentence += " "
                sentence += "."
                doc += sentence
    ...
    aspect_brand_ranking = open(data_dir + 'brand_ranking.txt', 'w')
